...
from model_server.utils import model_info_utils, prediction_utils, tensor_utils


def generate_api_docs():
    modules = [core, tensor_utils, prediction_utils, model_info_utils]

    md_gen = MarkdownAPIGenerator(
        "model_server", "https://github.com/Abhijit-2592/model-server/tree/master"
    )
    for m in modules:
