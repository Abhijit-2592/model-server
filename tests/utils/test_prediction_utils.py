...
def test_create_predict_request():
    ...
    assert np.array_equal(utils.create_array_from_proto(tensor_proto=request_proto.inputs["some_name"]), array)
...
def test_create_predict_response():
    ...
    assert np.array_equal(utils.create_array_from_proto(tensor_proto=response_proto.outputs["some_name"]), array)
